...
export const areas: Area[] = [
  ...
  },
  {
    ...
    body: [
      'Bridge of Weir gardens are generally larger than the regional average, and a good number sit on plots that shade into semi-rural ground — long boundaries, mature trees, paddock edges and open outlooks over the Gryffe. That scale changes the nature of the work. Boundary management becomes a significant job in itself, with hedging, tree lines and encroaching growth needing regular attention to stop the garden being gradually closed in from the edges.',
  ...
  },
  {
    ...
    body: [
      ...
      'The upside of the flat ground is that landscaping is straightforward when it comes to levels — there is rarely a slope to fight. Work is more often about drainage, surfaces and defining space: putting in paths and hard standing that stay usable through winter, raising or improving beds so planting is not sitting in wet ground, and cutting proper edges so the lawn holds its shape.',
  ...
  },
  {
    ...
    body: [
      ...
      'The village sits high, on the edge of open moorland, and it is cold and exposed compared with the towns down on the Clyde. Spring arrives later, the first frosts come earlier, and wind off the higher ground is a real factor on the more open plots. Planting choices need to reflect that honestly — species that thrive in a sheltered Glasgow back garden are not a safe bet here.',
